...
df = pdr.DataReader(user_input, 'stooq', start, end)                #use stooq
...
#moving averages
st.subheader('Predicted Close Price with 100MA and 200MA')
...
final_df = pd.concat([past_100_days,data_testing], ignore_index = True)      #concat instead of append
